...
namespace AWSSDK_DotNet.IntegrationTests.Tests.DynamoDB
{
    public partial class DynamoDBTests : TestBase<AmazonDynamoDBClient>
    {
        ...
        /// static table definitions that avoid the internal describe call to populate the cache
        /// </summary>
        [TestMethod]
        public void TestTableOperationsViaBuilder()
        {
            foreach (var conversion in new DynamoDBEntryConversion[] { DynamoDBEntryConversion.V1, DynamoDBEntryConversion.V2 })
            {
                ...
                var hashTable = new TableBuilder(Client, "DotNetTests-HashTable", conversion, true)
                ...
                var hashRangeTable = new TableBuilder(Client, "DotNetTests-HashRangeTable", conversion, true)
                ...
                var numericHashRangeTable = new TableBuilder(Client, "DotNetTests-NumericHashRangeTable", conversion, true)
